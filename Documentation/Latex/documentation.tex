...
You should describe how you have worked, not what you produced, in this section."
    ...
    The method used for producing the API design specification was Scenario-driven design. Each member created use-cases, and matching client-code individually, then compared these. After 2 or 3 iterations, new client-code was produced as a group. This client-code received feedback from a user-tester, student-assistant, or supervisor, using an iterative process.

    The group meet weekly to measure progress. Virtual communication and resource-sharing happened through Discord and GitHub.

    Frequent meetings with supervisor to answer any relevant questions we had during the process.
...
\section{Design Process/Results}
    ...
    After some time we knew what we wanted the code ot looke like and how to simplify it more, and that is when we started to use "Builder pattern" instead of the heavy object coding we had previously. This made it more readable for the eyes and work with.
        ...
        \textbf{Make a body element and append it to the HTML page. Then create header, main and footer elements and append it to the body element.}
        ...
        \textbf{Give the header element a main heading for the page}
        ...
        \textbf{Make a second custom heading and add it to the main element. Make a paragraph element and give it an arbitrary Id.}
